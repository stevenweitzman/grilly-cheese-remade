          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Celebrate the mom-to-be with delicious, Instagram-worthy food truck catering. Our award-winning grilled cheese and comfort food menu is perfect for baby showers of all sizes.
              </p>
            ...
            <div className="max-w-3xl mx-auto">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg"><strong>Stress-Free Service:</strong> Let the mom-to-be enjoy her day while we handle all the food</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
                  <span className="text-lg"><strong>Crowd-Pleasing Menu:</strong> Comfort food that everyone loves, with dietary accommodations</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
                  <span className="text-lg"><strong>Instagram-Worthy:</strong> Our colorful truck and food make perfect photo backdrops</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
                  <span className="text-lg"><strong>Indoor/Outdoor Flexible:</strong> Perfect for backyard parties or venue celebrations</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
                  <span className="text-lg"><strong>All Group Sizes:</strong> From intimate gatherings to 200+ guests</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="contact" className="py-20 bg-gradient-to-r from-accent/10 to-primary/10">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Book Your Baby Shower?
            </h2>
