  ...
  const faqs = [
    {
      ...
      answer: "Food truck catering typically costs $10-35 per person, with most events falling in the $14-25 range. Total costs depend on guest count, menu selections, and travel distance."
    },
    {
